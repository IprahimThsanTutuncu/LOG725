...
int main()
{
    ...
    controlSetting.add(sf::Keyboard::P, Config::InputState::isReleased, Config::InputAction::stop_run);
    ...
    controlSetting.add(sf::Keyboard::O, Config::InputState::isReleased, Config::InputAction::stop_aim);
