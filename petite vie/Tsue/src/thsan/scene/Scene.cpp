...
#include "thsan/scene/SpawnerStaticGameObject.h"
#include "thsan/scene/SerializerStaticGameObject.h"
...
#include "thsan/gameObject/terrain/TerrainRenderComponent.h"
#include "thsan/util/helper.h"

#include "thsan/graphic/RendererPseudo3D.h"
#include "thsan/graphic/RendererPseudo3D_Dynamic.h"
#include "thsan/graphic/RendererPseudo3D_Fixed.h"
#include "thsan/graphic/RendererPseudo3D_preRender.h"
...
void Scene::updateGameObjectComponent(GameObject* go)
{
    ...
    if (go->hasData(DATA_TYPE::TRANSFORM))
        transform = go->getData<Transform>(DATA_TYPE::TRANSFORM);
    if (go->hasData(DATA_TYPE::HITBOX))
        hitBox = go->getData<HitBox>(DATA_TYPE::HITBOX);
